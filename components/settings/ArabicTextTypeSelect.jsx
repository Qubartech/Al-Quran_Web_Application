...
export default function ArabicTextTypeSelect({ value, onChange, resolvedTheme }) {
  ...
  return (
    <div className="space-y-2">
      ...
      >
        ...
        />
        <ToggleButton value="uthmani" sx={{ zIndex: 1 }}>
          <span>Uthmani</span>
        </ToggleButton>
        <ToggleButton value="indopak" sx={{ zIndex: 1 }}>
          <span>IndoPak</span>
        </ToggleButton>
        <ToggleButton value="tajweed" sx={{ zIndex: 1 }}>
          <span>Tajweed</span>
        </ToggleButton>
      </ToggleButtonGroup>
    </div>
