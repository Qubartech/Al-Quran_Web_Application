...
const Card = React.forwardRef(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-3xl border border-slate-800 bg-slate-900/90 text-slate-100 shadow-xl backdrop-blur-md transition-all",
      className
    )}
    {...props}
  />
...
const CardTitle = React.forwardRef(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn("font-extrabold leading-none tracking-tight text-white", className)}
    {...props}
  />
))
