    ...
    <div className="w-full flex flex-col gap-2">
      ...
      <div className="w-full overflow-x-auto rounded-3xl glass border border-emerald-100/80 dark:border-slate-800 shadow-xs backdrop-blur-md">
        <table className="w-full text-left text-xs border-collapse min-w-[760px] md:min-w-full">
          ...
          {/* Table Header */}
          <thead>
            <tr className="bg-slate-50 dark:bg-slate-800/90 text-slate-700 dark:text-slate-200 border-b border-slate-200 dark:border-slate-800 font-extrabold uppercase tracking-wider sticky top-0 z-10 backdrop-blur-md">
            ...
            {days.map((d, idx) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Fajr */}
                  <td className="py-3.5 px-3 font-extrabold text-slate-800 dark:text-slate-100 whitespace-nowrap">
                    {formatTime12(t.Fajr)}
                  </td>

                  {/* Sunrise */}
                  <td className="py-3.5 px-3 text-slate-500 dark:text-slate-400 whitespace-nowrap font-medium">
                  ...
                  {/* Maghrib */}
                  <td className="py-3.5 px-3 font-extrabold text-rose-600 dark:text-rose-300 whitespace-nowrap">
                  ...
                  {/* Qiyam / Last Third */}
                  <td className="py-3.5 px-3 text-slate-600 dark:text-slate-300 whitespace-nowrap text-[11px]">
                    <div className="flex flex-col">
                      <span className="font-bold">{formatTime12(t.Lastthird)} (Qiyam)</span>
                      <span className="text-[10px] text-slate-500 dark:text-slate-400">Mid: {formatTime12(t.Midnight)}</span>
                    </div>
                  </td>

                  {/* Fasting Duration */}
                  <td className="py-3.5 px-3 text-center whitespace-nowrap">
                    <span className="px-2.5 py-1 rounded-xl bg-teal-500/10 dark:bg-teal-500/15 text-teal-600 dark:text-teal-300 border border-teal-500/20 dark:border-teal-500/30 font-extrabold text-[11px]">
                      {fasting}
                    </span>
                  </td>
                  ...
                  <td className="py-3.5 px-4 text-center">
                    <div className="flex items-center justify-center gap-1.5 flex-wrap">
                      ...
                      {completedCount > 0 && (
                        <span className="px-2 py-0.5 rounded-lg bg-emerald-500/10 dark:bg-emerald-500/20 text-emerald-600 dark:text-emerald-300 border border-emerald-500/20 dark:border-emerald-500/30 text-[11px] font-extrabold flex items-center gap-1">
                      ...
                      <ChevronRight size={15} className="text-slate-500 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 group-hover:translate-x-0.5 transition-all ml-1" />
                    </div>
                  </td>
