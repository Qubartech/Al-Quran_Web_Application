        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <div className="flex items-center gap-3 bg-white/80 dark:bg-slate-900/60 p-3 rounded-2xl border border-emerald-100/80 dark:border-slate-800 backdrop-blur-md shrink-0 shadow-2xs">
            <div className="text-center px-2">
              <span className="text-lg font-black text-emerald-600 dark:text-emerald-400 block">114</span>
              <span className="text-[10px] font-bold text-slate-500 dark:text-gray-400 uppercase">Surahs</span>
            </div>
